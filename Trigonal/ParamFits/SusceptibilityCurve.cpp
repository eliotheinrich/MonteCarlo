...
int main(int argc, char* argv[]) {
    ...
    TrigonalModel *model1 = new TrigonalModel(N, L, J1, J2, K1, K2, K3, B1, S);
    TrigonalModel *model2 = new TrigonalModel(N, L, J1, J2, K1, K2, K3, B2, S);
    TrigonalModel *model3 = new TrigonalModel(N, L, J1, J2, K1, K2, K3, B3, S);
