...
class SpinModel : virtual public MCModel {
    ...
    public:
        ...
        inline void set_spin(int i, Eigen::Vector3d S) {
            if (tracking) {
        ...
        void add_bond(int d1, int d2, int d3, int ds, Eigen::Vector3d v, std::function<double(Eigen::Vector3d, Eigen::Vector3d)> bondfunc) {
        ...
        inline Eigen::Vector3d get_magnetization() {
        ...
        std::vector<double> correlation_function(int i, int a = 2, int b = 2) {
        ...
        std::vector<double> full_correlation_function(int i) {
            std::vector<double> Cij = std::vector<double>(V); 
        ...
        std::vector<double> skyrmion_correlation_function(int i) {
            std::vector<double> Cij = std::vector<double>(V); 
        ...
        virtual const double onsite_func(const Eigen::Vector3d& S)=0;

        virtual const double onsite_energy(int i) {
#ifdef CLUSTER_UPDATE
        ...
        virtual const double bond_energy(int i) {
            double E = 0.;
            int j;
            for (int n = 0; n < bonds.size(); n++) {
                j = neighbors[i][n];
